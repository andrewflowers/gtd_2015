...
# Load raw data
#rawData <- read_csv("globalterrorismdb_0615dist.csv")
...
# All EU fatalities (of those pre-1986 countries) from 2005 until now
euFatalities %>% filter(iyear>2004) %>% summarize(sum(fatalities))
